...
class Visor:
	...
	def __init__(self, dado: float):
		self.dado: float = dado
...
class BombaCombustivel:
	...
	def __init__(self, tipo_combustivel: str, preco_litro: float):
	...
	def abastecer(self, valor_maximo: float):
		self.zerar()
...
class BombaPosto:
	...
	def __init__(self):
		self.bomba_gasolina =  BombaCombustivel(
			BombaCombustivel.GASOLINA, valor=5.89
		)
		self.bomba_alcool =  BombaCombustivel(
			BombaCombustivel.ALCOOL, valor=2.45
		)

	def abastecer_gasolina(self, valor_maximo: float):
		self.bomba_gasolina.abastecer(valor_maximo)

	def abastecer_alcool(self, valor_maximo: float):
		self.bomba_alcool.abastecer(valor_maximo)

	def alterar_preco_gasolina(self, novo_preco: float):
		self.bomba_gasolina.set_preco_litro(novo_preco)

	def alterar_preco_alcool(self, novo_preco: float):
		self.bomba_alcool.set_preco_litro(novo_preco)
